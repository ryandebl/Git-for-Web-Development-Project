...
Stretch Review questions: 
    ...
    5. In your own words, explain the box model. What is the fix for the box model? The box model is margin, border, padding, and content in that order outside in. The fix for the box model is box-sizing border-box. This has been changed with newer versions of CSS I believe.
Stretch Git Tasks
